...
# name
PRODUCT_RELEASE_NAME := TMOGS3

# device
$(call inherit-product-if-exists, device/samsung/d2tmo/full_d2tmo.mk)
...
PRODUCT_NAME := ukg_d2tmo
PRODUCT_MODEL := Samsung Galaxy S 3
PRODUCT_MANUFACTURER := Samsung
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.d2tmo.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="d2tmo-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/d2tmo:4.2.2/JDQ39/573038:user/release-keys"
